                ...
                for (let num of participants) {
                    ...
                    if (checkinfo) {
                        ...
                        if (anu.action == 'add' && events == "true") {
                            ...
                            let goodbye_messages = checkinfo.goodbye.replace(/@منشن/gi, `@${num.split("@")[0]}`).replace(/@اسم/gi, metadata.subject).replace(/@وصف/gi, metadata.desc).replace(/@اعضاء/gi, allmem).replace(/@akida/gi, `@${34612538080}`);
